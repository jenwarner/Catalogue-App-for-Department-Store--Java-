 ...
 * @author jenz_
 */
public class EditStockItem extends javax.swing.JFrame {

    /**
     * Creates new form EditStockItem
     */
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update existing stock item");

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/stock/img/edit_item.png"))); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Appliances", "Clothing", "Electronics", "Gift Items", "Video Games" }));
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/stock/img/Gmarket_1.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditStockItem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditStockItem().setVisible(true);
            }
        });
    }
